...
from ThreeDDFA_utils.onnx import convert_to_onnx
from ThreeDDFA_utils.io import _load
from ThreeDDFA_utils.functions import (
    crop_img, parse_roi_box_from_bbox, parse_roi_box_from_landmark,
)
from ThreeDDFA_utils.tddfa_util import _parse_param, similar_transform
...
class TDDFA_ONNX(object):
    ...
    def __init__(self, **kvs):
        ...
        bfm_fp = kvs.get('bfm_fp', make_abs_path('ThreeDDFA_configs/bfm_noneck_v3.pkl'))
        ...
        param_mean_std_fp = "ThreeDDFA_configs/param_mean_std_62d_{}x{}.pkl".format(self.size, self.size)
