...
from ThreeDDFA_utils.io import _load, _numpy_to_cuda, _numpy_to_tensor
...
def _load_tri(bfm_fp):
    if osp.split(bfm_fp)[-1] == 'bfm_noneck_v3.pkl':
        tri = _load(make_abs_path('../ThreeDDFA_configs/tri.pkl'))  # this tri/face is re-built for bfm_noneck_v3
    else:
...
if __name__ == '__main__':
    convert_bfm_to_onnx('../ThreeDDFA_configs/bfm_noneck_v3.onnx')
